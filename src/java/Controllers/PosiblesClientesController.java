    ...
    public void btnGuardar(HttpServletRequest request,
        ...
        try {
            ...
            if (request.getParameter("txtCorreoE") != null) {
                obclsPosiblesClientes.setStCorreoElectronico(request.getParameter("txtCorreoE"));
            }
            ...
            if (request.getParameter("txtIngresosanuales") != null) {
                obclsPosiblesClientes.setDbIngresosAnuales(Double.parseDouble(request.getParameter("txtCantidadEmpleados")));
            }
